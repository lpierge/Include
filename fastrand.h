...
/*
	...
	Xorshift32 e' un PRNG (pseudo random numer generator) leggendario per velocita'. Questa implementazione
	specifica (13, 17, 5) e' quella classica di George Marsaglia.
...
/*
	...
	2147483647, ma qui emula la rand() originale (ANSI C tipico).
*/
#if RAND_MAX > 32767
